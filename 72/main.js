...
var Game = function(){
    ...
    var drawWall = function(x,y0,y1){
        ...
        var bh = y0+segHeight;
        while(bh < y1){
            ctx.fillRect(x0,th,segWidth,segHeight);
            ctx.strokeRect(x0,th,segWidth,segHeight);
            th+=segHeight;
            bh+=segHeight;
            drawLeaf(x0,th,true);
            drawLeaf(x0+segWidth,th,false);
        }
        ctx.fillRect(x0,th,segWidth,y1-th);
        ctx.strokeRect(x0,th,segWidth,y1-th);
    };
