...
var Game = function(){
    ...
    var gameOver = function(){
        gameover = true;
        paused = true;
        var a = body.add("div",false,false,"width:500px;height:500px;position:absolute;top:0px;background-color:#00000044;padding:100px;text-align:center;");
        a.add("div","game over",false,"margin:20px;padding:5px;font-size:20px;background-color:#ffffff00;");
        a.add("div","score: "+birdx,false,"margin:20px;padding:5px;font-size:20px;background-color:#ffffff00;");
